...
para cualquier character como defender, evadir o atacar. En los tres casosse generaron cantidades 
de ataque aleatorias para hacer los test. Para el caso de atacar se testearon los 9 casos posibles 
